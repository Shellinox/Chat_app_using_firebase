...
class _GroupTileState extends State<GroupTile> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        nextScreen(context, ChatPage(groupName: widget.groupName, userName: widget.userName, groupId: widget.groupId,));
      },
      child: Container(
        ...
        child: ListTile(
          leading: CircleAvatar(
            ...
            title: Text(widget.groupName,style: const TextStyle(fontWeight: FontWeight.w500)),
